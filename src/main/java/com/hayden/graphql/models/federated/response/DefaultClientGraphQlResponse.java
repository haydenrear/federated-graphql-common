 ...
 * @since 1.0.0
 */
public final class DefaultClientGraphQlResponse extends ResponseMapGraphQlResponse implements ClientGraphQlResponse {
    ...
    public DefaultClientGraphQlResponse(
            ClientGraphQlRequest request, GraphQlResponse response,
    ...
    public ClientResponseField field(String path) {
        return new DefaultClientResponseField(new FederatedClientGraphQlResponse(request, this, encoder, decoder), super.field(path));
    }
